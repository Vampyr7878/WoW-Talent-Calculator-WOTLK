...
namespace WoW_Talent_Calculator_WOTLK
{
    ...
    class FormattedToolTip : ToolTip
    {
        ...
        private void onDraw(object sender, DrawToolTipEventArgs e)
        {
            ...
            if (this.ToolTipTitle == "Empty")
            {
                graphics.DrawString(this.ToolTipTitle, new Font(e.Font, FontStyle.Regular), Brushes.Gray, new PointF(e.Bounds.X + 1, e.Bounds.Y + 1));
            }
            else
            {
            ...
            if (lines[0].Contains("Glyph"))
            {
                graphics.DrawString(lines[0], new Font(e.Font, FontStyle.Regular), Brushes.SkyBlue, new PointF(e.Bounds.X, e.Bounds.Y + 16));
            }
            else
            {
